...
public class CSVService {
    ...
    public void importStudents(String filePath) throws IOException {
        ...
        try (Reader reader = new BufferedReader(new FileReader(file))) {
            // Configure the mapping strategy for Student entities
            ...
            // Build CSV to Bean parser with specified settings
            ...
            // Parse the CSV and get a list of Student objects
            List<Student> studentsFromCSV = csvToBean.parse();

            // Process each student from the CSV list
    ...
    // Method to import teams from a CSV file
    public void importTeams(String filePath) throws IOException {
        // Similar logic as importStudents method, adapted for TeamCSV entities
            File file = new File(filePath);
    ...
    // Method to export project evaluations to a CSV file
    public void exportEvaluations(Writer writer, Long courseId) throws IOException {
        // Retrieve project evaluations for a specific course
        ...
        // Iterate through project evaluations and write data to the CSV
        for (ProjectEvaluation evaluation : evaluations) {
            // Check if both Criterion and Student IDs are present
            if (evaluation.getCriterionId() != null && evaluation.getStudentId() != null) {
                // Retrieve Criterion and Student entities from their repositories
                ...
                if (criterion != null && student != null) {
                    // Extract relevant information and write to the CSV file
